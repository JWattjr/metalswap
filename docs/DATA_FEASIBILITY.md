...
A 2026-09-15 verification probe returned HTTP 503 from both endpoints, so that deployment was not funded or settled against XAUS. On 2026-09-16 both exact validator URLs returned HTTP 200 again. Each response reported `fresh` sampler state, 91 paired two-minute points, `coverage_seconds=10798`, and a body of roughly 3 KiB. This confirms current access and schema compatibility, not continuous availability or maximum-size payload behavior.
