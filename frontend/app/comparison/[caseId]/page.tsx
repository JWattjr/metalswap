      ...
      <div className="comparison-shell">
        ...
        <section className="comparison-card comparison-settlement">
          ...
          {settlement ? <>
            ...
            <p className="comparison-muted">Market contract: <code>{settlement.market_contract}</code>. Settlement gate: <code>{settlement.settlement_gate}</code>.</p>
            {"historical_position_readable" in settlement ? <p className="comparison-muted">Historical position readback after rotation: <strong>{settlement.historical_position_readable ? "AVAILABLE" : "UNAVAILABLE"}</strong>{"post_rotation_market_id" in settlement ? ` while ${settlement.post_rotation_market_id} was current` : ""}.</p> : null}
